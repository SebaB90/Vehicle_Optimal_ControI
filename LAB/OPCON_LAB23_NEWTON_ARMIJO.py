...
ax.plot3D(xx[0,:max_iters-1], xx[1,:max_iters-1], ll[:max_iters-1], color = 'tab:blue')
ax.scatter3D(xx[0,:max_iters-1], xx[1,:max_iters-1], ll[:max_iters-1], color = 'tab:blue')
ax.set_xlabel('$x^k_0$')
ax.set_ylabel('$x^k_1$')
